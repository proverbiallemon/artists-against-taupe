...
const OurColorfulCredo: React.FC = () => {
  return (
    <section id="credo">
      ...
      <p>Instead of a place where basic needs are met, I was inspired to go above and beyond with art and community and color, to also curate a space where the environment allows your brain a moment for peace, escape, and inspiration as well.</p>
      <p>I envisioned the kind of space that doesn’t remind you that you need help.  I wanted to change the look of help. </p>
